...
2. Buka folder tersebut, lalu klik ganda (double-click) pada file `index.html`.
3. Aplikasi akan langsung terbuka di browser default Anda (Chrome, Edge, Firefox, dll).

Cara 2: Menggunakan Ekstensi VS Code "Live Server" (Direkomendasikan)
Jika Anda menggunakan Visual Studio Code, cara ini lebih disarankan agar fitur JavaScript berjalan lebih optimal tanpa kendala CORS policy.
...
├── style.css    # Gaya dan tampilan (bila ada)
└── app.js       # Logika dan fitur aplikasi (bila ada)
